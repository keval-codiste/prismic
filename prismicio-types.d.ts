...
interface HomeSliceSliceDefaultPrimary {
  /**
   * HomeText field in *HomeSlice → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: home_slice.primary.hometext
   * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
   *
   */
  hometext: prismicT.RichTextField;
}
/**
 ...
 *
 */
export type HomeSliceSliceDefault = prismicT.SharedSliceVariation<
  "default",
 ...
 *
 */
export type HomeSliceSlice = prismicT.SharedSlice<
  "home_slice",
